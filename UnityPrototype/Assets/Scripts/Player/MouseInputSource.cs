...
public class MouseInputSource : IInputSource
{
	...
	public void FrameStart(InputState previousState)
	{
		...
		currentState = new InputState(previousState, Input.GetAxis("Horizontal"), Input.GetButton("Jump"), fireButtons, aimDirection, Time.time, playerTransform.localPosition);
	}
